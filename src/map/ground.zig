...
pub fn create() void {
    for (0..50) |index| {
        ...
        const offset: f32 = (i - 25.0) * 32.0;
        const sprite_index: usize = if (@mod(index, 2) == 0) game.assets.scoopems_atlas.Ground_full_0_Layer_0 else game.assets.scoopems_atlas.Ground_full_1_Layer_0;
